...
function! s:SpaceHi()
    if !exists("b:spacehi") || b:spacehi != 1
        " highlight tabs
        syntax match spacehiTab /\t/ containedin=ALL display oneline
        execute("highlight spacehiTab " . g:spacehi_tabcolor)

        " highlight trailing spaces
        syntax match spacehiTrailingSpace /\s\+$/ containedin=ALL display oneline
